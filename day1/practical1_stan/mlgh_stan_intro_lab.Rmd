...
model1_po <- data.table::melt(model1_po, 
                              id.vars = 'iteration'
                              )
set(model1_po, NULL, 'variable', model1_po[, as.character(variable)])
set(model1_po, NULL, 'chain', model1_po[, gsub('(.*)\\.(.*)','\\1',variable)])
set(model1_po, NULL, 'chain', model1_po[, as.integer(gsub('chain:','',chain))])
set(model1_po, NULL, 'variable', model1_po[, gsub('(.*)\\.(.*)','\\2',variable)])
...
```{r, include=TRUE, eval=FALSE, message=FALSE, echo=TRUE, warning=FALSE, tidy=TRUE, cache=TRUE}
require(data.table) # data mangling
require(tidyverse) # data mangling
require(bayesplot) # plot Stan output
require(knitr) # for Rmarkdown
...
# change this line as needed to point to the directory 
#    where all output from this lab is stored
out.dir <- '/Users/or105/Library/CloudStorage/OneDrive-ImperialCollegeLondon/OR_Work/teaching/2023-24/2023-24_MScBiomedicalStats/lectures/content_stan_intro'
